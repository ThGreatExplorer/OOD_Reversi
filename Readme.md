    ...
    2. Customizing game:
        ...
        - The next word will be the second player, and if the computer player is picked,
          there must be a next word for the strategy.
            ...
            - To toggle hints on and off, press "h" on your keyboard while the game has started.
...
This was done using the idea of Neighbors
in [redblobgames](https://www.redblobgames.com/grids/hexagons/)
...
2. View Changes:
    ...
    3. Added GameOver where if the model's game over method returns true, then when the view
       updates,
