...
public class ReversiTextualViewTest {
  ...
  public void unfinishedGameSize4() {
    ...
    game1.move(-3, 2, 1);//black
    game1.move(-1, -1, 2);//white
    game1.move(-1, 2, -1);//black
    game1.move(-1, 3, -2);//white
    game1.move(1, -2, 1);//black
    game1.move(2, -1, -1);//white
  ...
  public void unfinishedGameSize3() {
    ...
    game1.move(-1, -1, 2);//white
    game1.move(-1, -2, 3);//black
    game1.move(-2, -1, 3);//white
    game1.move(1, -2, 1);//black
    game1.move(-1, 2, -1);//white
    game1.move(-1, 3, -2);//black
    game1.move(-2, 1, 1);//white
